...
<template>
  <div class="agreement">
    ...
    />
    <div>
      <h2 style="text-align: center">友链用户协议</h2>
      <br />
      <div>
        ...
        <div style="text-indent: 2em">
          3、本网站保留在任何时候修改本协议条款的权利，且无需另行通知。在本网站修改协议条款后，如果您不接受修改后的条款，请立即停止使用本产品提供的服务，继续使用本产品提供的服务将被视为接受修改后的协议。
        </div>
      </div>
      ...
      <div style="margin-top: 5px">
        <div style="text-indent: 2em; font-weight: 900">
          四、服务变更、中断或终止
        </div>
        <div style="text-indent: 2em">
          1、鉴于网络服务的特殊性(包括但不限于服务器的稳定性问题、恶意的网络攻击等行为的存在及其他无法控制的情形)，用户同意本网站有权随时中断或终止部分或全部的服务。
        </div>
        <div style="text-indent: 2em">
          2、本网站需要定期或不定期地对提供服务的系统或相关设备进行检修或维护，如因此类情况而造成服务在合理时间内的中断，本网站无需为此承担任何责任。
        </div>
        <div style="text-indent: 2em">
          3、如发生下列任何一种情形，本网站有权随时变更、中断或终止向用户提供本协议项下的服务而无需对用户或任何第三方承担任何责任：
        </div>
        <div style="text-indent: 2em">
        ...
        <div style="text-indent: 2em">(3)按照法律规定或有权机关的要求；</div>
        <div style="text-indent: 2em">(4)出于安全的原因或其他必要的情形。</div>
      </div>
      <div style="margin-top: 5px">
        <div style="text-indent: 2em; font-weight: 900">
          五、用户个人隐私信息保护
        ...
        <div style="text-indent: 2em">2、信息收集</div>
        <div style="text-indent: 2em">(1)用户提供</div>
        <div style="text-indent: 2em">
        ...
        <div style="text-indent: 2em">(2)自动收集</div>
        <div style="text-indent: 2em">
        ...
        <div style="text-indent: 2em">3、信息使用</div>
        <div style="text-indent: 2em">
          (1)除本隐私政策未载明或本隐私政策的更新未能首先通知您的情况下，您的个人信息将不会用于其他目的。
        </div>
        <div style="text-indent: 2em">
          (2)匿名汇总统计数据不是本网站所定义的个人用户信息，我们将为多种目的，包括但不限于分析和使用模式的报告等，来保存和使用此类信息。本网站保留以任何目的或单方面许可第三方使用和披露匿名汇总统计数据的权利。
        </div>
        <div style="text-indent: 2em">
          (3)您在本产品中上传的信息，有可能会损坏您或他人的合法权益，您必须充分意识此类风险的存在。您明确同意，自行承担因上传信息所存在的一切风险及后果，本网站无需承担任何责任。
        </div>
        <div style="text-indent: 2em">4、法定披露</div>
        <div style="text-indent: 2em">
          虽然我们会尽最大努力保护用户隐私，但当我们有理由相信只有公开个人信息才能遵循现行司法程序、
          法院指令或其他法律程序或者保护本网站、本网站用户或第三方的权利、财产或安全时，我们可能披露个人信息。
        </div>
        <div style="text-indent: 2em">5、信息安全</div>
        <div style="text-indent: 2em">
          我们会采取合理的实际及电子手段以及规程保障措施来保护您的个人信息。
          虽然通过因特网信息传输数据并非100%
          安全，但我们已经采取并将继续采取商业范畴内合理的努力来确保您的个人信息得到保护。
        </div>
        <div style="text-indent: 2em">6、未成年人隐私保护</div>
        <div style="text-indent: 2em">
          本网站重视对未成年人个人隐私信息的保护。本网站将依赖用户提供的个人信息判断用户是否为未成年人。任何18岁以下的未成年人注册账号或使用本服务应事先取得家长或其法定监护人(以下简称“监护人”)的书面同意。除根据法律法规的规定及有权机关的指示披露外，本网站不会使用向任何第三方透露未成年人的个人隐私信息。
        </div>
      </div>
      <div style="margin-top: 5px">
        ...
        <div style="text-indent: 2em">(1)反对宪法所确定的基本原则的；</div>
        <div style="text-indent: 2em">
          (2)危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一的；
        </div>
        <div style="text-indent: 2em">(3)损害国家荣誉和利益的；</div>
        <div style="text-indent: 2em">
        ...
        <div style="text-indent: 2em">(1)含有任何性暗示的；</div>
        <div style="text-indent: 2em">(2)含有辱骂、恐吓、威胁内容的；</div>
        <div style="text-indent: 2em">
          (3)含有骚扰、垃圾广告、恶意信息、诱骗信息的；
        </div>
        <div style="text-indent: 2em">(4)涉及他人隐私、个人信息或资料的；</div>
        <div style="text-indent: 2em">
      ...
      <div style="margin-top: 5px">
        ...
        <div style="text-indent: 2em">
          1、用户在本服务中或通过本服务所传送、发布的任何内容并不反映或代表，也不得被视为反映或代表本网站的观点、立场或政策，本网站对此不承担任何责任。
        </div>
        <div style="text-indent: 2em">
        ...
        <div style="text-indent: 2em">
          3、用户须对利用本产品账号或本服务传送信息的真实性、合法性、无害性、准确性、有效性等全权负责，与用户所传播信息相关的任何法律责任由用户自行承担，与本网站无关。如因此给本网站或第三方造成损害的，用户应当依法予以赔偿。
        </div>
        <div style="text-indent: 2em">
          4、本产品提供的服务中可能包括广告，用户同意在使用过程中显示本产品和第三方供应商、合作伙伴提供的广告。除法律法规明确规定外，用户应自行对该广告信息进行的交易负责，对用户因该广告信息进行的交易或前述广告商提供的内容或遭受的损失或损害，本网站不承担任何责任。
        </div>
        <div style="text-indent: 2em">
      ...
      <div style="margin-top: 5px">
        ...
        <div style="text-indent: 2em">
          1、对于经由本产品服务而传送的内容，本网站不保证前述内容的正确性、完整性或品质。用户在接受有关服务时，有可能会接触到令人不快、不适当或令人厌恶的内容。在任何情况下，本网站均不对任何内容负责，包括但不限于任何内容发生任何错误或纰漏以及衍生的任何损失或损害。用户使用上述内容，应自行承担风险。
        </div>
        <div style="text-indent: 2em">
          2、用户明确同意其使用本产品所存在的风险及其后果将完全由其自己承担，本网站对用户不承担任何责任。如因用户违反有关法律、法规或本协议项下的任何条款而给任何其他第三人造成损失，用户同意承担由此造成的损害赔偿责任。
        </div>
        <div style="text-indent: 2em">
          3、本网站尊重并保护用户的个人隐私权。但因恶意的网络攻击等行为及其他无法控制的情形，导致用户隐私信息泄露的，用户同意本网站不承担任何责任。
        </div>
        <div style="text-indent: 2em">
          4、对于因电信系统或互联网网络故障、计算机故障、计算机系统问题或其它任何不可抗力原因而产生损失，本网站不承担任何责任，但将尽力减少因此给用户造成的损失和影响。
        </div>
      </div>
      <div style="margin-top: 5px">
        ...
        <div style="text-indent: 2em">
          2、本协议未授予用户使用本产品任何商标、服务标记、标识、域名和其他显著品牌特征的权利，任何人不得擅自(包括但不限于：以非法的方式复制、传播、展示、镜像、上载、下载)使用，否则本网站将依法追究法律责任。
        </div>
        <div style="text-indent: 2em">
      ...
      <div style="margin-top: 5px">
        ...
        <div style="text-indent: 2em">
          2、用户和本网站一致同意本协议。在执行本协议过程中如发生纠纷，双方应友好协商解决；协商不成时，任何一方可直接向所在地的人民法院提起诉讼。
        </div>
      </div>
      <div style="margin-top: 5px">
